<%@ Page Title="" Language="C#" MasterPageFile="~/HiveMind.Master" AutoEventWireup="true" CodeBehind="ExibirMorador.aspx.cs" Inherits="ProjetoFrontEnd.cadastros.ExibirMorador" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function confirma() {
            if (confirm("Deseja realmente apagar o morador?")) {
                return true;
            } else {
                return false;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="corpo" runat="server">
    ...
    <%} %>
    <div class="form-group">
        <asp:Label ID="lblDataEntradaL" runat="server" Text="Entrada: " meta:resourcekey="lblDataEntradaLResource1" />
        <asp:Label ID="lblDataEntrada" runat="server" meta:resourcekey="lblDataEntradaResource1" />
    </div>
    <div class="form-group">
        <asp:Label ID="lblDataSaidaL" runat="server" Text="Saida: " meta:resourcekey="lblDataSaidaLResource1" />
        <asp:Label ID="lblDataSaida" runat="server" meta:resourcekey="lblDataSaidaResource1" />
    </div>
