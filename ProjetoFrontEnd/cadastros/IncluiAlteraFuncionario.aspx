<%@ Page Title="" Language="C#" MasterPageFile="~/HiveMind.Master" AutoEventWireup="true" CodeBehind="IncluiAlteraFuncionario.aspx.cs" Inherits="ProjetoFrontEnd.cadastros.IncluiAlteraFuncionario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="corpo" runat="server">
    ...
    <fieldset>
        ...
        <div class="form-group col-md-3">
            ...
            <asp:Label ID="lblDataAdmi" runat="server" 
                Text="Data de Admissao" CssClass="control-label"></asp:Label>

            <asp:TextBox ID="txtDataAdmi" CssClass="form-control" MaxLength="10" onkeypress="return Mascara(this, Data);"
                 runat="server" placeholder="DD/MM/AAAA ex:31/12/1999"></asp:TextBox>
        </div>

        <div class="form-group col-md-3">
            
            <asp:Label ID="lblDataDemi" runat="server" 
                Text="Data de Demissão" CssClass="control-label"></asp:Label>

            <asp:TextBox ID="txtDataDemi" CssClass="form-control" MaxLength="10" onkeypress="return Mascara(this, Data);"
                 runat="server" placeholder="DD/MM/AAAA ex:31/12/1999"></asp:TextBox>
        </div>

        <div class="form-group btn-lg">
            <asp:Label ID="lblStatusAdmin" Text="Administrador" CssClass="control-label pull-right" 
                runat="server"></asp:Label>
            <asp:CheckBox ID="cbxStatusAdmin" runat="server" 
                Checked="true" CssClass="pull-right" OnCheckedChanged="cbxStatusAdmin_CheckedChanged"></asp:CheckBox>                 
        </div>
