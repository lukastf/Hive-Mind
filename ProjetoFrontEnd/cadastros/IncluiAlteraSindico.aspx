<%@ Page Title="" Language="C#" MasterPageFile="~/HiveMind.Master" AutoEventWireup="true" CodeBehind="IncluiAlteraSindico.aspx.cs" Inherits="ProjetoFrontEnd.cadastros.IncluiAlteraSindico" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../res/js/mascaras.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="corpo" runat="server">
    <fieldset>
    <legend>Cadastro de Sindico</legend>
    ...
    <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-10">           
            ...
            <asp:TextBox ID="txtTelefone" CssClass="form-control" onkeypress="return Mascara(this, Telefone);"
                 runat="server" placeholder="Telefone"></asp:TextBox>
        </div>
        <div class="form-group col-md-5">           
            <asp:Label ID="lblEndereco" runat="server" 
                Text="Endereco: " CssClass="control-label"></asp:Label>
            <asp:TextBox ID="txtEndereco" CssClass="form-control" onkeypress="return Mascara(this, Endereco);"
        ...
        <div class="form-group col-md-10">
            <asp:Label ID="lblDescricao" runat="server" 
                Text="Descrição: " CssClass="control-label" ></asp:Label>

            <asp:TextBox ID="txtDescricao" CssClass="form-control"
                 runat="server" placeholder="Digite o apartamento do sindico" TextMode="MultiLine"></asp:TextBox>
        </div>
