<%@ Page Title="" Language="C#" MasterPageFile="~/HiveMind.Master" AutoEventWireup="true" CodeBehind="ExibirProprietario.aspx.cs" Inherits="ProjetoFrontEnd.cadastros.ExibirProprietario" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function confirma() {
            if (confirm("Deseja realmente apagar o proprietario?")) {
                return true;
            } else {
                return false;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="corpo" runat="server">
    ...
    <%} %>
    <div class="form-group">
        <asp:Label ID="lblInformacaoL" runat="server" Text="Informacao: " meta:resourcekey="lblInformacaoLResource1" />
