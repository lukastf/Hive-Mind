<%@ Page Title="" Language="C#" MasterPageFile="~/HiveMind.Master" AutoEventWireup="true" CodeBehind="ListaNotificacoesEnviadas.aspx.cs" Inherits="ProjetoFrontEnd.adicionarNotificacao.ListaNotificacoesEnviadas" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="corpo" runat="server">
    ...
    <asp:Repeater ID="listaNotificacoesEnviadas" runat="server">
        ...
        <HeaderTemplate>
            <table class="table table-condensed">
                <tr>
                    ...
                    <th>
                        <asp:Literal ID="Literal2" runat="server" Text="<%$ resources: destinatario %>"></asp:Literal>
                    </th>
                    <th>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td><%# DataBinder.Eval(Container.DataItem, "NomeDestinatario") %></td>
